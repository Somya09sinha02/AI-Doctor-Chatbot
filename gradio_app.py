...
def process_inputs(audio_filepath, image_filepath):
    try:
        if not audio_filepath:
            return "No audio received", "Please speak again", None

        groq_key = os.getenv("GROQ_API_KEY")
        if not groq_key:
            return "Config error", "GROQ_API_KEY not found", None
        ...
        if image_filepath and os.path.exists(image_filepath):
            ...
            doctor_response = "With what I hear, I need an image to give a better medical opinion."
